...
; <label>:17:                                     ; preds = %3
  call void @enqueue_signature_with_return(i32 65541)
  ret void
}
...
; <label>:15:                                     ; preds = %3
  call void @enqueue_signature_with_return(i32 131077)
  ret void
}
...
; <label>:16:                                     ; preds = %12
  call void @enqueue_signature_with_call(i32 196612)
...
; <label>:19:                                     ; preds = %17
  call void @enqueue_signature_with_call(i32 196614)
...
; <label>:24:                                     ; preds = %21
  call void @enqueue_signature_with_call(i32 196617)
  call void @calculation_type_B()
  br label %25
...
; <label>:29:                                     ; preds = %25
  call void @enqueue_signature_with_call(i32 196619)
  call void @calculation_type_A()
  br label %30
...
; <label>:32:                                     ; preds = %30
  call void @enqueue_signature_with_call(i32 196621)
...
; <label>:37:                                     ; preds = %33
  call void @enqueue_signature_with_call(i32 196623)
  call void @calculation_type_A()
  br label %38
...
; <label>:41:                                     ; preds = %38
  call void @enqueue_signature_with_call(i32 196625)
  call void @calculation_type_B()
  br label %42
...
; <label>:45:                                     ; preds = %21
  call void @enqueue_signature_with_call(i32 196627)
  call void @calculation_type_A()
  br label %46
...
; <label>:49:                                     ; preds = %46
  call void @enqueue_signature(i32 196629)
...
; <label>:70:                                     ; preds = %56
  call void @enqueue_signature_with_remainder_process(i32 196633)
