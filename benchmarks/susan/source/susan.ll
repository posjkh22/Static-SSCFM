...
; <label>:35:                                     ; preds = %29, %18
  ...
  %39 = call double @exp(double %38) #6
...
; <label>:119:                                    ; preds = %115
  ...
  %131 = call double @exp(double %130) #6
...
; <label>:603:                                    ; preds = %575
  ...
  %1244 = call double @sqrt(double %1243) #6
...
; <label>:251:                                    ; preds = %223
  ...
  %400 = call double @sqrt(double %399) #6
...
; <label>:35:                                     ; preds = %33, %2
  ...
  call void @get_image(i8* %38, i8** %9, i32* %25, i32* %26)
  br label %39

; <label>:39:                                     ; preds = %102, %35
...
; <label>:71:                                     ; preds = %66
  %72 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.30, i32 0, i32 0))
  br label %73
...
; <label>:90:                                     ; preds = %85
  %91 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.31, i32 0, i32 0))
  br label %92
...
; <label>:92:                                     ; preds = %90, %85
  ...
  %98 = call i32 @atoi(i8* %97) #8
  store i32 %98, i32* %15, align 4
  br label %99

; <label>:99:                                     ; preds = %53, %92, %84, %65, %64, %63, %62, %61, %60, %59, %58
  br label %102
...
; <label>:114:                                    ; preds = %112
  ...
  call void @setup_brightness_lut(i8** %10, i32 %115, i32 2)
  %116 = load i32, i32* %18, align 4
  ...
  call void @susan_smoothing(i32 %116, i8* %117, double %119, i32 %120, i32 %121, i8* %122)
  br label %261
...
; <label>:123:                                    ; preds = %112
  ...
  call void @setup_brightness_lut(i8** %10, i32 %131, i32 6)
...
; <label>:137:                                    ; preds = %134
  ...
  %144 = call i32 @susan_principle_small(i8* %138, i32* %139, i8* %140, i32 %141, i32 %142, i32 %143)
  br label %153
...
; <label>:145:                                    ; preds = %134
  ...
  %152 = call i32 @susan_principle(i8* %146, i32* %147, i8* %148, i32 %149, i32 %150, i32 %151)
  br label %153
...
; <label>:153:                                    ; preds = %145, %137
  ...
  %159 = call i32 @int_to_uchar(i32* %154, i8* %155, i32 %158)
  br label %207
...
; <label>:160:                                    ; preds = %123
  ...
  %170 = sext i32 %169 to i64
  call void @llvm.memset.p0i8.i64(i8* %166, i8 100, i64 %170, i32 1, i1 false)
  %171 = load i32, i32* %18, align 4
...
; <label>:173:                                    ; preds = %160
  ...
  %181 = call i32 @susan_edges_small(i8* %174, i32* %175, i8* %176, i8* %177, i32 %178, i32 %179, i32 %180)
  br label %191
...
; <label>:182:                                    ; preds = %160
  ...
  %190 = call i32 @susan_edges(i8* %183, i32* %184, i8* %185, i8* %186, i32 %187, i32 %188, i32 %189)
  br label %191
...
; <label>:194:                                    ; preds = %191
  ...
  %199 = call i32 @susan_thin(i32* %195, i8* %196, i32 %197, i32 %198)
  br label %200
...
; <label>:200:                                    ; preds = %194, %191
  ...
  %206 = call i32 @edge_draw(i8* %201, i8* %202, i32 %203, i32 %204, i32 %205)
  br label %207

; <label>:207:                                    ; preds = %200, %153
  br label %261
...
; <label>:208:                                    ; preds = %112
  ...
  %213 = mul i64 %212, 4
  %214 = call noalias i8* @malloc(i64 %213) #6
  %215 = bitcast i8* %214 to i32*
  store i32* %215, i32** %13, align 8
  %216 = load i32, i32* %15, align 4
  call void @setup_brightness_lut(i8** %10, i32 %216, i32 6)
...
; <label>:219:                                    ; preds = %208
  ...
  %226 = call i32 @susan_principle(i8* %220, i32* %221, i8* %222, i32 %223, i32 %224, i32 %225)
  %227 = load i32*, i32** %13, align 8
  %228 = load i8*, i8** %9, align 8
  %229 = load i32, i32* %25, align 4
  %230 = load i32, i32* %26, align 4
  %231 = mul nsw i32 %229, %230
  %232 = call i32 @int_to_uchar(i32* %227, i8* %228, i32 %231)
  br label %260
...
; <label>:236:                                    ; preds = %233
  ...
  %241 = getelementptr inbounds [15000 x %struct.anon], [15000 x %struct.anon]* %27, i32 0, i32 0
  %242 = load i32, i32* %25, align 4
  %243 = load i32, i32* %26, align 4
  %244 = call i32 @susan_corners_quick(i8* %237, i32* %238, i8* %239, i32 %240, %struct.anon* %241, i32 %242, i32 %243)
  br label %254
...
; <label>:245:                                    ; preds = %233
  ...
  %249 = load i32, i32* %21, align 4
  %250 = getelementptr inbounds [15000 x %struct.anon], [15000 x %struct.anon]* %27, i32 0, i32 0
  %251 = load i32, i32* %25, align 4
  %252 = load i32, i32* %26, align 4
  %253 = call i32 @susan_corners(i8* %246, i32* %247, i8* %248, i32 %249, %struct.anon* %250, i32 %251, i32 %252)
  br label %254
...
; <label>:254:                                    ; preds = %245, %236
  ...
  %259 = call i32 @corner_draw(i8* %255, %struct.anon* %256, i32 %257, i32 %258)
  br label %260

; <label>:260:                                    ; preds = %254, %219
  br label %261

; <label>:261:                                    ; preds = %112, %260, %207, %114
  ...
  %268 = call i32 @put_image(i8* %264, i8* %265, i32 %266, i32 %267)
  %269 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.32, i32 0, i32 0))
  %270 = call i32 (%struct.timeval*, i8*, ...) bitcast (i32 (...)* @gettimeofday to i32 (%struct.timeval*, i8*, ...)*)(%struct.timeval* %29, i8* null)
  %271 = getelementptr inbounds %struct.timeval, %struct.timeval* %29, i32 0, i32 0
  %272 = load i64, i64* %271, align 8
  %273 = getelementptr inbounds %struct.timeval, %struct.timeval* %28, i32 0, i32 0
  %274 = load i64, i64* %273, align 8
  %275 = sub nsw i64 %272, %274
  %276 = mul nsw i64 %275, 1000000
  %277 = getelementptr inbounds %struct.timeval, %struct.timeval* %29, i32 0, i32 1
  %278 = load i64, i64* %277, align 8
  %279 = getelementptr inbounds %struct.timeval, %struct.timeval* %28, i32 0, i32 1
  %280 = load i64, i64* %279, align 8
  %281 = sub nsw i64 %278, %280
  %282 = add nsw i64 %276, %281
  %283 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.33, i32 0, i32 0), i64 %282)
